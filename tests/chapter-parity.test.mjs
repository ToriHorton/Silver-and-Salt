...
const reviewedVersionNamespaces = {
  ...
  // 0.53.0 adds no namespace: re-terming paid founding members onto a while_active
  ...
  // 0.55.0 stores combined checkout selection inside existing quote/intent JSON.
