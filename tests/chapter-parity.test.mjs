...
const candidateVersions = ["0.47.11", "0.48.0", "0.48.1", "0.48.2", "0.48.3", "0.49.0", "0.50.0", "0.51.0"];
const hasAccountProtection = ["0.48.1", "0.48.2", "0.48.3", "0.49.0", "0.50.0", "0.51.0"].includes(chapterVersion);
const hasSeatJourneys = ["0.49.0", "0.50.0", "0.51.0"].includes(chapterVersion);
